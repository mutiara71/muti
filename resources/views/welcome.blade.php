    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand"><a href="#page-top">PengaduanMasyarakat</a></li>
                @if (Route::has('login'))
                <li class="sidebar-nav-item">@auth<a href="{{ url('/home') }}">Home</a>@else
                @if (Route::has('register'))<a href="{{ url('login') }}">Login</a>
                </li>
                @endif
